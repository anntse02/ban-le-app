    ...
    <div className="space-y-2.5">
      ...
      {subTab === "stock" && (
        <div className="space-y-2.5">
          ...
          {/* Nút Reset Về 0 - Vùng nguy hiểm */}
          <div className="pt-2 border-t border-dashed border-red-300">
            <button
              type="button"
              onClick={async () => {
              ...
              className="w-full py-2 rounded-xl transition flex items-center justify-center gap-1.5 bg-red-50 text-red-600 hover:bg-red-100 border border-red-200 text-sm font-bold"
            >
